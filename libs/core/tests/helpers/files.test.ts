...
import {listFilesRecursively, createFileHash, checkFileHash} from '@/helpers/files';
...
describe('Files helpers tests', () => {
    ...
    it('should create the hash of the file', () => {
       ...
       const fileHash: string = 'a591a6d40bf420404a011733cfb7b190d62c65bf0bcda32b57b277d9ad9f146e';
